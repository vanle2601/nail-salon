...
const Login = () => {
  ...
  return (
    <>
      ...
      <div className="mb-6">
        <div className="bg-gray-100 flex flex-direction-col justify-center mt-2 mb-8 grow">
        ...
        <div className="flex flex-direction-col justify-center justify-around items-center pt-4 mx-5 grow">
